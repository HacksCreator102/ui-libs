...
function Message:Windows11(titleText, bodyText, callback)
	...
	TextLabel.Text = bodyText or "Message"
	...
	ButtonsView.Position = UDim2.new(0.5, -100, 0.8, 0)
	ButtonsView.Size = UDim2.new(0, 200, 0, 30)
	...
	YesButton.Parent = ButtonsView
	YesButton.Size = UDim2.new(0, 80, 1, 0)
	YesButton.BackgroundColor3 = Color3.fromRGB(240, 240, 240)
	...
	NoButton.Parent = ButtonsView
	NoButton.Size = UDim2.new(0, 80, 1, 0)
	NoButton.BackgroundColor3 = Color3.fromRGB(240, 240, 240)
